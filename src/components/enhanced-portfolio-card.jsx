          ...
          <Card
            ...
            <motion.div
              ...
              <p className="text-gray-300 text-lg leading-relaxed">
                I'm a passionate Cross-platform Mobile App Developer with 3+ years of experience
                in developing scalable and maintainable applications using Flutter and Dart. I'm
                highly skilled in designing and developing user interfaces, writing clean and
                modular code, and working with various third-party APIs and services. As a
                Flutter developer, I'm always eager to learn and explore new technologies and
                frameworks. When I'm not coding, I enjoy playing with my cat, watching anime, or
                exploring new outdoor spots.
              </p>
              <p className="text-gray-300 text-lg leading-relaxed">
