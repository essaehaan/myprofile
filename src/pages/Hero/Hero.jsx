...
export default function Hero() {
  const words = [
    ...
    "WordPress Developer & Shopify Expert",
    "Learning MARN Stack",
...
const profile = {
    name: 'Essa Ehaan',
    title: 'Flutter Developer | Cloud Enthusiast | Problem Solver',
    skills: [
        'Flutter', 'Dart', 'JavaScript', 'Liquid',
        'WordPress', 'Shopify', 'Wix', 'WebFlow', 'CSS',
        'HTML5', 'BootStrap', 
    ],
    hardWorker: true,
    quickLearner: true,
            ...
            <div className="w-full lg:w-1/2 mb-12 lg:mb-0 animate__animated animate__fadeInLeft relative">
              ...
              <div className="relative mb-8 sm:mb-12 max-w-xl">
                <p className="text-base sm:text-xl text-gray-300/90 leading-relaxed">
                  JavaScript lover 🚀 | Flutter Developer 🔧 | 
                  Coding the future 💻✨
                </p>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 animate__animated animate__fadeInUp animate__delay-2s">
                ...
                <a
                  href="https://github.com/essaehaan"
